...
procs = [
  ...
  NativeProcess("ui", "selfdrive/ui", ["./ui"], always_run, enabled=(not PC), watchdog_max_dt=(5 if not PC else None)),
  PythonProcess("raylib_ui", "selfdrive.ui.ui", always_run, enabled=PC, watchdog_max_dt=(5 if not PC else None)),
